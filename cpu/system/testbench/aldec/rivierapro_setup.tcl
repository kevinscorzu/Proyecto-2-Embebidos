...
# ACDS 20.1 720 win32 2021.09.21.17:08:05
# ----------------------------------------
...
ensure_lib                                       ./libraries/SEG7_S0                              
vmap       SEG7_S0                               ./libraries/SEG7_S0                              
ensure_lib                                       ./libraries/RAM                                  
vmap       RAM                                   ./libraries/RAM                                  
ensure_lib                                       ./libraries/CPU                                  
vmap       CPU                                   ./libraries/CPU                                  
ensure_lib                                       ./libraries/system_inst_seg7s0_bfm               
vmap       system_inst_seg7s0_bfm                ./libraries/system_inst_seg7s0_bfm               
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/system_SEG7_S0.v"                                                                           -work SEG7_S0                              
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_conduit_bfm.sv"                                         -l altera_common_sv_packages -work system_inst_seg7s0_bfm               
