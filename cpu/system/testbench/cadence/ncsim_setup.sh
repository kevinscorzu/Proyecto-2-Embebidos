...
mkdir -p ./libraries/SEG7_S0/
mkdir -p ./libraries/RAM/
mkdir -p ./libraries/CPU/
mkdir -p ./libraries/system_inst_seg7s0_bfm/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/system_tb/simulation/submodules/system_SEG7_S0.v"                                              -work SEG7_S0                               -cdslib ./cds_libs/SEG7_S0.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_conduit_bfm.sv"                                         -work system_inst_seg7s0_bfm                -cdslib ./cds_libs/system_inst_seg7s0_bfm.cds.lib               
